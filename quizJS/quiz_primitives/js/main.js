  ...
  // When the user decides to validate his answer it is compared to the correctAnswer
    $(".validate").click(function() {
      ...
      if (userAnswer === correctAnswer) {
        $(this).after("<p class='result good'><i class='fa fa-check-circle fa-1x' aria-hidden='true'></i>  Bonne réponse</p>");
        score = score + 1;
        $(".score p").html( score + "/" + finalscore );
      }
      else {
        $(this).after("<p class='result bad'><i class='fa fa-times-circle fa-1x' aria-hidden='true'></i>  Mauvaise réponse</p>");
      }
